...
public class MainActivity extends Activity {
	 ...
	 * sostanzialmente quel metodo permette di trasformare un oggettto che non è scritto 
	 * in java(xml) in un oggetto java reale e concretto 	
	 */
	...
	private void startNewGame() {
		...
		if (mHumanFirst) {
			...
			// la prossima volta che parte il gioco, toccherà al giocatore di giocare 
			mHumanFirst = true;
		}
	...
	// siamo qua se e solo se il gioco non è finito e se il bottone non è disabilitato
