...
//
//public class ButtonClickListenerold implements View.OnClickListener {
//	int location;
...
//	
//	public ButtonClickListenerold(Button boardButtons[], int location, TextView infoTextView, MatchManager matchManager) {
