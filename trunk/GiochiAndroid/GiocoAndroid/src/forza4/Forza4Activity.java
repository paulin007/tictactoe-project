...
public class Forza4Activity extends Activity {
	...
	private MatchManager matchManager = new MatchManager(client,
			messageInterpreter);
	private GraphicManagerForza4 graphicManagerForza4 = new GraphicManagerForza4(
			this, matchManager, turnManager);
